...
当前稿：v36（2026-09-23；有限范围准确性和解释小修，新增作者 ORCID 链接；实验与结论正文及表格数据不变）。修改清单见 [CHANGELOG.md](CHANGELOG.md)，合作者替换建议与待确认事项见 [HANDOFF_NOTES.md](HANDOFF_NOTES.md)。本轮不关闭尚缺原始记录或门户核验的问题。

v36 新稿 SHA-256：`0ef729d8bc6e8941312ec69e0ac7ad70824807d3de2d22d09edd28e78265e7b4`。P0-08：PDF 作者姓名已加入五个对应 ORCID 链接；双通讯提交前确认和外部身份绑定仍待作者。Table 2 的显示值 59.43−58.42=1.01 与所报 1.02 不一致，列为原始精度待核查，尚未归因于四舍五入，未改表值。
