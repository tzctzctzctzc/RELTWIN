...
当前稿：v20（`paper` 协作稿；经作者确认合入 v19/v20，论文内容对应 `e209eb1`）

清单审计日期：2026-09-14

论文提交截止：2026-09-16（以 [ICASSP 2027 Paper Kit](https://cmsworkshops.com/ICASSP2027/papers/paper_kit.php) 为准）

> 当前策略：用既有三 benchmark 主表先呈现提升，再介绍 NOVA 方法，重点展开 RelTwin 候选训练和机制分析。模型与评测配置集中在设置中说明，正文采用直接的科研论述。本轮只改论文，不执行新模型实验。
...
| P1 | 6 | P1-02、P1-05 已完成；其余为设置、图注、时间干预终检、Scope、结论和版面 |
| P2 | 3 | 最后一轮语言与 PDF QA |
| P3 | 4 | 全部需要新实验，当前延后 |
...
5. **P1-03、P1-04、P1-06、P1-07**：图注与 timing 待终检，继续改进 Scope 和 Conclusion；P1-05 的公开结果重点已完成；
...
- 当前 PDF SHA-256：`44fb2acf818cb7c2f0b40f3bad7b264c8bd0e5f0030b9528a8ba0560b41f4263`
