...
**当前是 v11 Figure 1 ICASSP 风格更新稿，不是已完成投稿检查的终稿。** 本轮在首轮改图提交 `29506ae` 上调整主图风格、连线与间距，同步图注和 `paper.pdf`；实验数据、方法与结果段未变。修改保存在 `codex/reltwin-figure1-redesign`，尚未合入 `paper`。旧版本由 Git 历史保存。编辑与编译方法见 [README.md](README.md)。
...
- 位置：PDF 第 4–5 页。
- 现状：技术内容在第 4 页结束；本轮缩紧主图后，参考文献 [1]–[12] 完整位于第 4 页，第 5 页列出 [13]–[17]。尚未形成作者要求的“前四页正文、第五页集中放文献”。
...
- 现状：92/239/69 的胜平负、两条 IoU 下降至少 0.5 的样本仍缺少错误类型说明；`25 remain incorrect` 仍重复呈现成功率。主图及对应案例说明已在本轮改为聚焦同一答案到查询对应窗口的恢复；原始边界和 IoU 保持不变，此部分见已关闭的 W05。
...
- 当前 PDF SHA-256：`c1bb522e1cd91e609cb39395f813d9a220f0fcbf6af6a51c888c556dd1531928`。
