...
当前稿：v17（P0-03/P0-04 方法定义审阅稿；分支 `docs/p0-03-04-method-20260914`，待作者确认后合入 `paper`）
...
| 优先级 | 活动问题 | 当前判断 |
|---|---:|---|
| P0 | 5 | 其中 3 项为论文内容或终检，2 项涉及作者信息与提交合规；P0-01 至 P0-04 已完成 |
...
P0-01 至 P0-04 已完成，具体修改与合理性审查见第 7 节。其他条目不因本轮方法定义补全而自动关闭。
...
- **当前残留**：
  ...
  - 图注中的内部查询编号与 `seed 0`
- **v16 进展**：表格行名已改为方法身份，去掉 `Current SFT, s0` 和 `SpotSound-A (re-eval.)`；训练 seed、统计形式和对照身份改由分组标题及设置说明。设置与图注中的其他工程语言未在本轮整体改写。
...
4. **P0-06 + P1-01**：继续清理内部审计语言并重整设置；P1-02 的机制表分组已完成；
5. **P1-03、P1-04、P1-06、P1-07**：统一图注、timing、Scope 和 Conclusion；P1-05 的公开结果重点已完成；
...
- 当前 PDF SHA-256：`94e04a1b9302944aa58a35eb82ebdfb3261626d0063e768abf1194e1bc1354fb`
